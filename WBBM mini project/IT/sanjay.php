...
<body>
    ...
    $amount = 4000; // constant value
    $consultant = 'sanjay'; // constant value
    $consultant_email = 'sanjay@gmail.com';
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($amount) && !empty($transaction_id)) {
            ...
            echo "Name, Email, Amount, and Transaction ID are required fields.";
        }
    }
    ?>
